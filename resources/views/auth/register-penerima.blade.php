...
<head>
    <meta charset="UTF-8">
    <title>Daftar Sebagai Penerima</title>
    <style>
        body {
...
<div class="container">
    ...
    <form method="POST" action="{{ route('register.penerima.submit') }}">
        @csrf
        <div class="form-group">
            <label><i class="fa fa-id-card"></i>ID (otomatis)</label>
            <input type="text" name="kode_user" class="form-control" value="PXXX" readonly>
        </div>
        <div class="form-group">
